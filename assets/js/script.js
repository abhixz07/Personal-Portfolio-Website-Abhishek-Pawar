...
const form = document.querySelector(".portfolio [data-form]");
const formInputs = document.querySelectorAll(".portfolio [data-form-input]");
const formBtn = document.querySelector(".portfolio [data-form-btn]");
...
//     // get clicked text (About, Resume, etc.)
...
navLinks.forEach((link, index) => {
  link.addEventListener("click", () => {
    ...
    // match article using lowercase text
